...
def Generate_DE_source(sample_size, intercept_Y, b_T_Y, b_Z2_Y, b_Z1_Y, Z1_mean_P, Z1_std_P, Z2_mean_P, Z2_std_P,
    ...
    b_Z3_Y, b_Z4_Y, b_Z5_Y, b_Z6_Y, b_Z7_Y, b_Z8_Y, b_Z9_Y = 0.6, 0.9, 0.3, 0.2, 1.5, -1, -0.9
    ...
    X_exp = np.column_stack((T, Z1, Z2, Z3, Z4, Z5, Z6, Z7, Z8, Z9))
...
def Generate_Do_target(sample_size, intercept_Y, b_T_Y, b_Z2_Y, b_Z1_Y, intercept_T, b_Z2_T, Z1_mean_PT, Z1_std_PT,
    ...
    X_obs = np.column_stack((T, Z1, Z2, Z3, Z4, Z5, Z6, Z7, Z8, Z9))
...
N_test = 1000
for Ne in Ne_list:
    n_runs = 3  # Number of different datasets that you want to test the algorithm
    columns = []
